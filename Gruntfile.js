module.exports = function(grunt) {
    ...
    var taskConfig = {
        ...
        /** sass handles our SASS compilation
         * Only our 'app.scss' file is included in compilation; all other files
         * must be imported from this file.
         * */
        sass: {
          //options: {
          //  includePaths: ['vendor/foundation5-sass/scss']
          //},
          build: {
            src: [ '<%= app_files.sass %>' ],
            dest: '<%= build_dir %>/assets/<%= pkg.name %>-<%= pkg.version %>.css'
    ...
    grunt.registerTask('build', [
        'clean', 'html2js', 'jshint', 'coffeelint', 'coffee', 'sass:build', //'recess:build',
    ...
    grunt.registerTask('compile', [
        ...
        'sass:compile', 'copy:compile_assets', 'concat:compile_js', 'uglify', 'index:compile' // taking out ngmin until I figure out how to get it to work with enclosures
    ]);
